...
// Enumerate all interfaces and endpoints of a device.
// enum_interface() are called for each interface. in addition enum_class_specific() is called for 
// class-specific descriptors seen. These two call-backs should return **1** for the enumeration to continue.
